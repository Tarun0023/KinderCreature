...
<head>
    ...
    <title>A bed in need is a friend indeed</title>
        ...
        <div class="container">
            <section class="donation-section">
                <div class="donation-content">
                    <h2>A bed in need is a friend indeed</h2>
                    <p>Animals, like us, need to be well rested to stay healthy. Beds cushion their tired joints and give them a feeling of security, thus helping them relax. Hard surfaces are harsh on their bodies, and the discomfort that results from a lack of sleep potentially leads to behavioural issues.</p>
                    <p>Kinder Creature is procuring beds for the animals at the shelter. A total of 30 small, 90 medium and 30 large-sized beds will be purchased — each costing INR 1000, 1200 and 1500 respectively.</p>
                    <p>Your contribution will help animals sleep better and live healthy lives.</p>
                    <button class="donate-btn">donate now (india donors)</button>
                </div>
                <div class="donation-image">
                    <img src="../images/beds-for-pets.jpeg" alt="Rescued cows relaxing at the sanctuary">
                </div>
            </section>

            <!-- New Campaign Section with Slider -->
            <section class="campaign-section">
                <h2>Discover other campaignss</h2>
