...
<head>
    ...
    <link rel="stylesheet" href="/KinderCreature/src/home_page/style.css">
        ...
        <div class="main">
            <div class="both-parent">
                ...
                <div class="content">
                    ...
                    <div class="button">
                        <a href="/KinderCreature/src/get_involved/donate/donate.php" class="support-btn">
                            Support Our Cause
                        </a>
                    </div>
                </div>
    ...
    <section class="treatment">
        <div class="container">
            <div class="heading-trt">
                ...
                <div class="line-img">
                    <img src="/KinderCreature/src/home_page/home_img/line.png" alt="">
                </div>
            </div>
            <div class="trt-container">
                <div class="trt-box">
                    <div class="trt-img">
                        <img src="/KinderCreature/src/home_page/home_img/bx1.jpeg" alt="">
                    </div>
                    ...
                    <div class="trt-btn">
                        <a href="/KinderCreatre/src/animal_in_care/animal_in_care.php" class="trt-btn-span">Read More</a>
                    </div>
                ...
                <div class="trt-box">
                    ...
                    <div class="trt-img">
                        <img src="/KinderCreature/src/home_page/home_img/bx2.jpeg" alt="">
                    </div>
                    <div class="trt-desrip">
                        <div class="name">
                            <a href="#" class="trt-a">
                ...
                <div class="trt-box">
                    <div class="trt-img">
                        <img src="/KinderCreature/src/home_page/home_img/bx3.jpeg" alt="">
                    </div>
                    <div class="trt-desrip">
                        <div class="name">
                            <a href="#" class="trt-a">
        ...
        <div class="container">
            <div class="both-container">
                <div class="both-boxs">
                    ...
                    <div class="trt-img">
                        <img src="/KinderCreature/src/home_page/home_img/ambulence.jpg" alt="">
                    </div>
                    <div class="contents">
                        <div class="discri">
                ...
                <div class="both-boxs">
                    ...
                    <div class="trt-img">
                        <img src="/KinderCreature/src/home_page/home_img/bed.jpg" alt="">
                    </div>
                    <div class="contents">
    ...
    <section class="care">
        <div class="container">
            ...
            <div class="card-container">
                <div class="card">
                    <img src="/KinderCreature/src/home_page/home_img/tips1.png" alt="Pet Introduction">
                    <div class="card-content">
                        ...
                        <div class="read-more">
                            <a href="/KinderCreature/src/who_we_are/blog/blog.php">Read More</a>
                        </div>
                    </div>
                </div>

                <div class="card">
                    <img src="/KinderCreature/src/home_page/home_img/tips2.jpg" alt="Bathing Fussy Pets">
                    <div class="card-content">
                ...
                <div class="card">
                    <img src="/KinderCreature/src/home_page/home_img/tips3.jpg" alt="Medication for Pets">
                    <div class="card-content">
    ...
    <section class="NGO-detial">
        <div class="container">
            <div class="Kinder-info">
                <div class="k-box">
                    <div class="k-image">
                        <img src="/KinderCreature/src/home_page/home_img/dogs.png" alt="">
                    </div>
                    <div class="k-content">
                        <div class="k-logo">
                            <!-- <img src="\kindercreature\img\web_logo.png" alt=""> -->
